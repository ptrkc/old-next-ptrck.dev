...
const Presentation = () => (
  <div className="w-full flex justify-between gap-8 flex-col sm:flex-row mx-auto">
    ...
    <div className="gap-4 flex flex-col items-baseline">
      ...
      <p>
        and I&apos;m a full-stack developer. I love to create things for both
        work and fun.
      </p>
      <p>
        I&apos;ve been using mostly JavaScript, TypeScript, React, Next.js, and
        Node.js.
      </p>
...
const Techs = () => (
  <div className="flex flex-col gap-4">
    <h1>Tech skills</h1>
    <p>Stuff I know + stuff I&apos;m learning*. Always open to learn more!</p>
    <div className="flex flex-wrap gap-6 justify-between">
      <div>
        <h2>Front-end</h2>
        <ul>
          <ListItem iconColor="text-orange-500" icon={<SiHtml5 />}>
            HTML
          </ListItem>
          <ListItem iconColor="text-blue-500" icon={<SiCss3 />}>
            CSS
          </ListItem>
          <ListItem iconColor="text-yellow-500" icon={<SiJavascript />}>
            JavaScript
          </ListItem>
          <ListItem iconColor="text-blue-500" icon={<SiTypescript />}>
            TypeScript
          </ListItem>
          <ListItem iconColor="text-blue-500" icon={<SiReact />}>
            React
          </ListItem>
          <ListItem icon={<SiNextdotjs />}>Next.js</ListItem>
          <ListItem iconColor="text-blue-500" icon={<SiTailwindcss />}>
            Tailwind CSS
          </ListItem>
          <ListItem iconColor="text-cyan-500" icon={<SiChakraui />}>
            Chakra-UI
          </ListItem>
          <ListItem iconColor="text-pink-500" icon={<SiStyledcomponents />}>
            styled-components
          </ListItem>
        </ul>
      </div>
      <div>
        ...
        <ul>
          ...
          <ListItem iconColor="text-green-500" icon={<SiNodedotjs />}>
            Node.js
          </ListItem>
          <ListItem icon={<SiExpress />}>Express</ListItem>
          <ListItem iconColor="text-blue-500" icon={<SiPostgresql />}>
            PostgreSQL
          </ListItem>
          <ListItem iconColor="text-sky-500" icon={<SiPrisma />}>
            Prisma
          </ListItem>
        </ul>
      </div>
      <div>
        <h2>Other</h2>
        <ul>
          <ListItem iconColor="text-blue-500" icon={<SiFlutter />}>
            Flutter*
          </ListItem>
          <ListItem iconColor="text-orange-500" icon={<SiGit />}>
            Git
          </ListItem>
          <ListItem icon={<SiGithub />}>GitHub</ListItem>
          <ListItem iconColor="text-blue-500" icon={<SiVisualstudiocode />}>
            VS Code
          </ListItem>
