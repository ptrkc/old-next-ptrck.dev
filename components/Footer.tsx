...
const Footer = () => (
  <footer className="p-8 dark:bg-white/10 bg-neutral-700 flex justify-around items-center flex-col gap-8 text-orange-100">
    <div className="mx-auto max-w-3xl flex gap-8">
      ...
      <ul className="flex flex-col gap-2">
        <li>
          <FooterLink href="https://github.com/ptrkc">GitHub</FooterLink>
        </li>
        <li>
          <FooterLink href="https://www.linkedin.com/in/patrickcarneiro/">
            LinkedIn
          </FooterLink>
        </li>
        <li>
          <FooterLink href="mailto:pcarneiro.dev@gmail.com">E-mail</FooterLink>
        </li>
      </ul>
    </div>
